      ...
      <div className="bg-white rounded-xl shadow-lg p-8">
        ...
        {status.type !== 'idle' && (
          <div className={`mb-6 p-4 rounded-lg flex items-center ${
            ...
            {status.type === 'loading' && <div className="w-5 h-5 mr-2 border-2 border-blue-600 border-t-transparent rounded-full animate-spin" />}
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="text-gray-700">Free consultation and quotation</span>
            </div>
            <div className="flex items-center">
              <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
